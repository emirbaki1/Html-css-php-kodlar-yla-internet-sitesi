                ...
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        ...
                        <form method="post" action="user_registration_script.php">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" placeholder="E-Posta" required="true" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                            </div> 
                            <div class="form-group">
                                <input type="password" class="form-control" name="password" placeholder="Şifre(min. 6 karakter)" required="true" pattern=".{6,}">
                            </div>
                            <div class="form-group"> 
                                <input type="tel" class="form-control" name="contact" placeholder="Telefon numarası" required="true">
                            </div>
                            <div class="form-group">
